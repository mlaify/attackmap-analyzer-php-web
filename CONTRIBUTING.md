# Contributing to `attackmap-analyzer-php-web`
...
```bash
git clone https://github.com/mlaify/attackmap-analyzer-php-web.git
cd attackmap-analyzer-php-web
python -m venv .venv
...
Open a [bug report](https://github.com/mlaify/attackmap-analyzer-php-web/issues/new?template=bug_report.md).
...
Open a [feature request](https://github.com/mlaify/attackmap-analyzer-php-web/issues/new?template=feature_request.md).
...
By contributing to `attackmap-analyzer-php-web`, you agree that your contributions will be
